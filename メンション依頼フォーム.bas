Attribute VB_Name = "modRequestFormBuilderV12"
Option Explicit

'============================================================
' 依頼入力ユーザーフォーム 自動生成（依頼3青系版 v12）
' 変更点：
...
Private Const UI_SCALE As Double = 1#
...
Public Sub BuildRequestEntryFormV12()
    ...
    MsgBox "フォームを作成しました。", vbInformation, "作成完了"
    Exit Sub
